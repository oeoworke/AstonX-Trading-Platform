...
import { 
  LayoutDashboard, TrendingUp, Wallet, History, LogOut, X, Trash2, Upload, Database, RefreshCw 
} from 'lucide-react'
...
function Dashboard() {
  ...
  const [isSyncing, setIsSyncing] = useState(false) // Syncing status-க்காக புதிய ஸ்டேட்
  ...
  // --- BULK SYNC FUNCTION (புதிதாகச் சேர்க்கப்பட்டது) ---
        ...
        <div>
          ...
          <nav className="mt-4 px-2 space-y-1">
            ...
            <button 
                ...
                disabled={isSyncing}
                className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-yellow-500 hover:bg-blue-900/20 rounded-lg transition-all ${isSyncing ? 'animate-pulse cursor-not-allowed opacity-50' : ''}`}
            >
        ...
        {view === 'overview' ? (
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                <div className="bg-gray-800 p-6 rounded-2xl border border-gray-700 shadow-lg"><p className="text-gray-500 text-xs font-bold uppercase mb-2 tracking-widest">Success Rate</p><p className="text-3xl font-black text-green-400">Stable</p></div>
      ...
      {isDeleteConfirmOpen && (
        <div className="absolute inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-[100] p-4 animate-in fade-in duration-300">
            <div className="bg-gray-800 w-full max-w-sm rounded-3xl border border-gray-700 shadow-2xl p-8 text-center">
                ...
                <p className="text-gray-400 text-sm mb-8 leading-relaxed">Are you sure you want to delete your profile picture? This action cannot be undone.</p>
